	...
	public static String parseToJPAWhereExpression(final CommonExpression whereExpression, final String tableAlias)
		...
		switch (whereExpression.getKind()) {
			...
			case MEMBER:
				...
				/*
				By : Shark
				Fix Bug (Where expression on Navigation Property):
				java.lang.ClassCastException: org.apache.olingo.odata2.core.edm.provider.EdmNavigationPropertyImplProv cannot be cast to org.apache.olingo.odata2.api.edm.EdmProperty
				 */
				memberExpStr =
