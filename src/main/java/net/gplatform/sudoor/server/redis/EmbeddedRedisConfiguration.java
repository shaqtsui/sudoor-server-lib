 ...
 */
package net.gplatform.sudoor.server.redis;
 ...
 */
@Configuration
//Assume production env need to have password enabled, if not fall back to mock
@ConditionalOnProperty(name = "spring.redis.password", matchIfMissing = true)
