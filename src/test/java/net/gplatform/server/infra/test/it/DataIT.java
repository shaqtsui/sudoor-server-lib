package net.gplatform.server.infra.test.it;
...
public class DataIT {
	...
	public final String REST_SERVICE_URL = "http://localhost:8080/infra-server-lib-1.0/data/rest";

	public final String ODATA_SERVICE_URL = "http://localhost:8080/infra-server-lib-1.0/data/odata.svc";
